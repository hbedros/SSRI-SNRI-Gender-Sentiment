...
#### OBSERVATION: 
We see that the avg death rate of males is higher than the avg of sexes togather and  the avge death rate of females.We see the avg death rate of females is lower than avg for the group.
...
#### Results: 
We reject the null hypothesis, so we reject that all means (of the suicide rates) are equal between the age_ranges.
